...
- restored the full scientific verification harness from the pre-reset scientific baseline onto current `main`, while retaining the stricter current schemas and extending the existing CBD validation workflow rather than reviving the superseded CI workflow;
