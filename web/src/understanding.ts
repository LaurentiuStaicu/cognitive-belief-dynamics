...
type Lang='ro'|'en';
type Mode='overview'|'theory'|'mechanisms'|'world-model'|'tour'|'active';
...
function route(){
 ...
 return {mode:['overview','theory','mechanisms','world-model','tour','active'].includes(mode)?mode:'overview',detail:parts[2]};
}
...
export function mountUnderstanding(
 ...
 const knownModes:Mode[]=['overview','theory','mechanisms','world-model','tour','active'];
