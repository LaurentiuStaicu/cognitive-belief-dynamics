...
import {isAppView,type AppView} from './navigation';
let graphMode='core';
let graphFocus='all';
...
function content(html:string) { document.getElementById('suiteAuxContext')!.innerHTML=html; }
function renderRuns() {
...
function renderStructure(){
 ...
 const host=document.getElementById('suiteAuxContext')!;
...
function renderProcess(){
 mountVisualOdd(document.getElementById('suiteAuxContext')!,lang,oddProcesses,subsystems);
}
