# Validation claim matrix — M1 with retained M0 baseline
...
| Claim | M0 status |
|---|---|
| Reproduce an illusory-truth pattern | In scope |
| Reproduce correction-related belief regression | In scope |
| Reproduce source-reliability weighting | In scope |
| Reproduce an accuracy-salience sharing effect | In scope |
| Prove a unique psychological mechanism | Out of scope |
| Estimate Track A / Track B population prevalence | Out of scope |
