...
Phase C is represented on Draft PR #24 and remains pre-runtime/model-comparison
only. Phase D is isolated on branch
`alpha-0.4.3a0-phase-d-discrimination-protocol`.
