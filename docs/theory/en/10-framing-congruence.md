# Presentation framing and prior-attitude congruence

> Alpha 0.4.1a1 skeleton · Phase A. Full theory prose has not yet been authored.

## Central idea

Explains M1.E2: semantic content remains fixed while confirmation/refutation framing and task-specific congruence discriminate nested engagement models.
...
Gatt is not stable ideology, and EngageIntent is not the retained M0 Share process.
