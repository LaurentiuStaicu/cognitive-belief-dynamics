# Cum folosesc CEM fără să confund harta cu teritoriul

## Ideea centrală

CEM este cel mai util când este parcurs într-o ordine care păstrează explicația înaintea optimizării:

Înțelege → explorează mecanismul → inspectează dovezile → compară factorii → planifică acțiunea.

[[VIEW:learning]] · [[VIEW:reference]] · [[VIEW:planning]] · [[VIEW:process]]
...
Folosește scenariile publicate pentru a vedea cum o singură schimbare afectează traiectoria. Compară modele nested acolo unde există. Nu interpreta diferențele demonstrative ca efecte procentuale în populație.
...
După Phase C, Phase D va adăuga Guided Tour: un traseu scurt, orientat pe sarcini, care va conduce utilizatorul prin aceleași suprafețe fără a înlocui teoria.

Start Guided Tour → va deveni activ când Phase D este implementată.

## Ce nu afirmă acest capitol

Folosirea corectă a aplicației nu elimină incertitudinea științifică. CEM este un instrument de explicare și testare a unor mecanisme candidate; valoarea lui crește atunci când limitele sunt inspectabile la fel de ușor ca rezultatele.